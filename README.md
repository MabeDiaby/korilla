...
## Part 1: Sample Receipts Data

We'll use this data to render some sample receipts:
...
Implement a search field that allows you to search by person. The receipts should automatically update as you type, hiding every receipt that doesn't match the name you're spelling out.

_**Hint:** Think about how the search will work. How do you make something happen while typing? What needs to happen? What values are you searching and comparing?_
